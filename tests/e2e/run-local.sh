...
if [[ ( "$requested_scenario" == "terrain-lod-near-quality" || "$requested_scenario" == "terrain-lod-remote-handoff" || "$requested_scenario" == "terrain-lod-natural-cave" ) && -z "${E2E_TIMEOUT_SECONDS:-}" ]]; then
    timeout_seconds=240
fi
