                    ...
                    if (!var3.multiplayerWorld)
                    {
                        ...
                        for (int var9 = 0; var9 < 128; ++var9)
                        {
                            ...
                            for (int var13 = 0; var13 < var9 / 16 && validPosition; ++var13)
                            {
                                ...
                                if (var3.getBlockId(var10, var11 - 1, var12) != Block.grass.id || var3.shouldSuffocate(var10, var11, var12))
                                {
                                    validPosition = false;
                                }
                            }
                            ...
                            if (validPosition && var3.getBlockId(var10, var11, var12) == 0)
                            {
                                ...
                                {
                                    var3.setBlockAndMetadataWithNotify(var10, var11, var12, Block.tallGrass.id, 1);
                                }
                                else if (itemRand.nextInt(3) != 0)
                                {
                                    var3.setBlockWithNotify(var10, var11, var12, Block.plantYellow.id);
                                }
                                else
                                {
                                    var3.setBlockWithNotify(var10, var11, var12, Block.plantRed.id);
                                }
                            }
                        }
                    }
