    ...
    public class ItemMap : ItemMapBase
    {
                    ...
                    if ((var12 & 15) == (var3.field_28175_g & 15))
                    {
                        ...
                        for (int var17 = var10 - var11 - 1; var17 < var10 + var11; ++var17)
                        {
                            if (var12 >= 0 && var17 >= -1 && var12 < var4 && var17 < var5)
                            {
                                ...
                                if (var34 > 0)
                                {
                                    MapColor var44 = Block.BLOCKS[var34].blockMaterial.mapColor;
        ...
        private void processBlockHeight(Chunk var27, int var33, int var28, int var34, int var29, ref int var35, out int var36, ref int var30)
        {
            ...
            while (!exitLoop)
            {
                ...
                else if (var35 > 0 && var36 > 0 && Block.BLOCKS[var36].blockMaterial.mapColor == MapColor.airColor)
                {
                    var37 = false;
                }
                ...
                if (var37)
                {
                    if (var36 == 0 || !Block.BLOCKS[var36].blockMaterial.isFluid())
                    {
                        exitLoop = true;
                    }
                    else
                    {
                        ...
                        while (true)
                        {
                            ...
                            ++var30;
                            if (var38 <= 0 || var43 == 0 || !Block.BLOCKS[var43].blockMaterial.isFluid())
                            {
                                exitLoop = true;
                                break;
                            }
