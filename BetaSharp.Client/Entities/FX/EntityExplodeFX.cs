...
public class EntityExplodeFX : EntityFX
{
    ...
    {
        base.velocityX = velocityX + (double)((float)(JavaRandom.Random() * 2.0D - 1.0D) * 0.05F);
        base.velocityY = velocityY + (double)((float)(JavaRandom.Random() * 2.0D - 1.0D) * 0.05F);
        base.velocityZ = velocityZ + (double)((float)(JavaRandom.Random() * 2.0D - 1.0D) * 0.05F);
