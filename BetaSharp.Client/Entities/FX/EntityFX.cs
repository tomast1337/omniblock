...
public class EntityFX : Entity
{
    ...
    public EntityFX(World world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) : base(world)
    {
        ...
        base.velocityX = velocityX + (double)((float)(JavaRandom.Random() * 2.0D - 1.0D) * 0.4F);
        base.velocityY = velocityY + (double)((float)(JavaRandom.Random() * 2.0D - 1.0D) * 0.4F);
        base.velocityZ = velocityZ + (double)((float)(JavaRandom.Random() * 2.0D - 1.0D) * 0.4F);
        float velocityScale = (float)(JavaRandom.Random() + JavaRandom.Random() + 1.0D) * 0.15F;
