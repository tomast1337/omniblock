...
public class EntityBubbleFX : EntityFX
{
    ...
    public EntityBubbleFX(World world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) : base(world, x, y, z, velocityX, velocityY, velocityZ)
    {
        ...
        base.velocityX = velocityX * (double)0.2F + (double)((float)(JavaRandom.Random() * 2.0D - 1.0D) * 0.02F);
        base.velocityY = velocityY * (double)0.2F + (double)((float)(JavaRandom.Random() * 2.0D - 1.0D) * 0.02F);
        base.velocityZ = velocityZ * (double)0.2F + (double)((float)(JavaRandom.Random() * 2.0D - 1.0D) * 0.02F);
