...
public class GameRenderer
{
    ...
    public void renderFrame(float tickDelta, long time)
    {
        ...
        applyFog(0);
        GLManager.GL.Enable(GLEnum.Fog);
        GLManager.GL.BindTexture(GLEnum.Texture2D, (uint)_client.textureManager.GetTextureId("/terrain.png").Id);
        Lighting.turnOff();
    ...
    protected void renderSnow(float tickDelta)
    {
        ...
        if (var2 > 0.0F)
        {
            ...
            GLManager.GL.BindTexture(GLEnum.Texture2D, (uint)_client.textureManager.GetTextureId("/environment/snow.png").Id);
            ...
            GLManager.GL.BindTexture(GLEnum.Texture2D, (uint)_client.textureManager.GetTextureId("/environment/rain.png").Id);
            var16 = 10;
