...
public class HeldItemRenderer
{
    ...
    public void renderItem(EntityLiving var1, ItemStack var2)
    {
        ...
        {
            GLManager.GL.BindTexture(GLEnum.Texture2D, (uint)mc.textureManager.GetTextureId("/terrain.png").Id);
        ...
        else
        {
            ...
            {
                GLManager.GL.BindTexture(GLEnum.Texture2D, (uint)mc.textureManager.GetTextureId("/gui/items.png").Id);
            }
    ...
    public void renderItemInFirstPerson(float var1)
    {
        ...
        if (var5 != null && var5.itemId == Item.Map.id)
        {
            ...
            GLManager.GL.Enable(GLEnum.RescaleNormal);
            //TODO: ADD SKINS
            GLManager.GL.BindTexture(GLEnum.Texture2D, (uint)mc.textureManager.GetTextureId(mc.player.getTexture()).Id);
            ...
            mc.textureManager.BindTexture(mc.textureManager.GetTextureId("/misc/mapbg.png").Id);
    ...
    public void renderOverlays(float var1)
    {
        ...
        {
            var2 = mc.textureManager.GetTextureId("/terrain.png").Id;
        ...
        if (mc.player.isInsideWall())
        {
            ...
            int var5 = mc.textureManager.GetTextureId("/terrain.png").Id;
        ...
        {
            var2 = mc.textureManager.GetTextureId("/misc/water.png").Id;
            GLManager.GL.BindTexture(GLEnum.Texture2D, (uint)var2);
