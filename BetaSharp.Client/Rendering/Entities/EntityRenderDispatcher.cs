...
public class EntityRenderDispatcher
{
    ...
    private EntityRenderDispatcher()
    {
        ...
        RegisterRenderer(typeof(EntityPig), new PigEntityRenderer(new PigBbModelModel(), new PigBbModelModel(0.5F), 0.7F));
        RegisterRenderer(typeof(EntitySheep), new SheepEntityRenderer(new SheepBbModelModel(), new SheepFurBbModelModel(), 0.7F));
        RegisterRenderer(typeof(EntityCow), new CowEntityRenderer(new CowBbModelModel(), 0.7F));
        RegisterRenderer(typeof(EntityWolf), new WolfEntityRenderer(new WolfBbModelModel(), 0.5F));
        RegisterRenderer(typeof(EntityChicken), new ChickenEntityRenderer(new ChickenBbModelModel(), 0.3F));
        RegisterRenderer(typeof(EntityCreeper), new CreeperEntityRenderer());
        RegisterRenderer(typeof(EntitySkeleton), new UndeadEntityRenderer(new SkeletonBbModelModel(), 0.5F));
        RegisterRenderer(typeof(EntityZombie), new UndeadEntityRenderer(new ZombieBbModelModel(), 0.5F));
        RegisterRenderer(typeof(EntitySlime), new SlimeEntityRenderer(new SlimeBbModelModel(), new SlimeCubeBbModelModel(), 0.25F));
        RegisterRenderer(typeof(EntityPlayer), new PlayerEntityRenderer());
        RegisterRenderer(typeof(EntityGiantZombie), new GiantEntityRenderer(new ZombieBbModelModel(), 0.5F, 6.0F));
        RegisterRenderer(typeof(EntityGhast), new GhastEntityRenderer());
        RegisterRenderer(typeof(EntitySquid), new SquidEntityRenderer(new SquidBbModelModel(), 0.7F));
        RegisterRenderer(typeof(EntityLiving), new LivingEntityRenderer(new BipedBbModelModel(), 0.5F));
