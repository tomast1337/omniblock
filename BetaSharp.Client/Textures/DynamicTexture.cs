...
public class DynamicTexture : java.lang.Object
{
    ...
    public void bind(TextureManager var1)
    {
        ...
        {
            GLManager.GL.BindTexture(GLEnum.Texture2D, (uint)var1.GetTextureId("/terrain.png").Id);
        }
        else if (atlas == FXImage.Items)
        {
            GLManager.GL.BindTexture(GLEnum.Texture2D, (uint)var1.GetTextureId("/gui/items.png").Id);
