...
public class FlatLayerListItem(FlatLayerInfo layer) : ListItem<FlatLayerInfo>(layer)
{
    ...
    public override void Render(UIRenderer renderer)
    {
        ...
        string blockName = block?.translateBlockName() ?? TranslationStorage.Instance.TranslateKey("newWorld.customize.unknown");
        ...
        renderer.DrawText(TranslationStorage.Instance.TranslateKey("newWorld.customize.height") + ": " + Value.LayerCount, 26, 16, Color.Gray80);
    }
}
