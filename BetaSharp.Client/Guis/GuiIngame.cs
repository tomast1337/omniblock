...
public class GuiIngame : Gui
{
    ...
    public void renderGameOverlay(float partialTicks, bool unusedFlag, int unusedA, int unusedB)
    {
        ...
        GLManager.GL.BindTexture(GLEnum.Texture2D, (uint)_mc.textureManager.GetTextureId("/gui/gui.png").Id);
        ...
        GLManager.GL.BindTexture(GLEnum.Texture2D, (uint)_mc.textureManager.GetTextureId("/gui/icons.png").Id);
    ...
    private void renderPumpkinBlur(int screenWidth, int screenHeight)
    {
        ...
        GLManager.GL.Color4(1.0F, 1.0F, 1.0F, 1.0F);
        GLManager.GL.Disable(GLEnum.AlphaTest);
        GLManager.GL.BindTexture(GLEnum.Texture2D, (uint)_mc.textureManager.GetTextureId("%blur%/misc/pumpkinblur.png").Id);
    ...
    private void renderVignette(float darkness, int screenWidth, int screenHeight)
    {
        ...
        GLManager.GL.BindTexture(GLEnum.Texture2D, (uint)_mc.textureManager.GetTextureId("%blur%/misc/vignette.png").Id);
        Tessellator tess = Tessellator.instance;
        tess.startDrawingQuads();
        tess.addVertexWithUV(0.0D, screenHeight, -90.0D, 0.0D, 1.0D);
        tess.addVertexWithUV(screenWidth, screenHeight, -90.0D, 1.0D, 1.0D);
    ...
    private void renderPortalOverlay(float portalStrength, int screenWidth, int screenHeight)
    {
        ...
        GLManager.GL.BindTexture(GLEnum.Texture2D, (uint)_mc.textureManager.GetTextureId("/terrain.png").Id);
