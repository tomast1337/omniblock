...
internal static class BehaviorRegistry
{
    ...
    private static readonly Dictionary<string, BehaviorFactory> s_factories = new()
    {
        ...
        ["dispenser"] = json => new DispenserBehavior(
            ResolveItem(json.GetProperty("arrow").GetString()!),
            ResolveItem(json.GetProperty("egg").GetString()!),
            ResolveItem(json.GetProperty("snowball").GetString()!)),
        ...
        ["fire"] = json => new FireBehavior(
            ResolveBlock(json.GetProperty("obsidian").GetString()!),
            ResolveBlock(json.GetProperty("nether_portal").GetString()!),
            ResolveBlock(json.GetProperty("netherrack").GetString()!),
            ResolveBlock(json.GetProperty("tnt").GetString()!)),
        ...
        ["portal"] = json => new PortalBehavior(ResolveBlock(json.GetProperty("obsidian").GetString()!)),
        ["redstone_ore"] = _ => new RedstoneOreBehavior(),
        ["redstone_wire"] = json => new RedstoneWireBehavior(
            ResolveBlock(json.GetProperty("wire").GetString()!),
            ResolveBlockArray(json.GetProperty("conductors")),
            ResolveBlock(json.GetProperty("repeater").GetString()!),
        ...
        ["snow"] = json => new SnowBehavior(ResolveItem(json.GetProperty("snowball").GetString()!)),
