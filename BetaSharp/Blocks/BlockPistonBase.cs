...
public class BlockPistonBase : Block
{
    ...
    public override void onBlockAction(World world, int x, int y, int z, int data1, int data2)
    {
        ...
        else if (data1 == 1)
        {
            ...
            world.setBlockWithoutNotifyingNeighbors(x, y, z, Block.MovingPiston.id, data2);
            ...
            if (sticky)
            {
                ...
                bool var14 = false;
                if (var12 == Block.MovingPiston.id)
                {
                ...
                else
                {
                    ...
                    world.setBlockWithoutNotifyingNeighbors(x, y, z, Block.MovingPiston.id, var13);
    ...
    private bool push(World world, int x, int y, int z, int dir)
    {
        ...
        while (true)
        {
            ...
            while (var6 != x || var7 != y || var8 != z)
            {
                ...
                {
                    world.setBlockWithoutNotifyingNeighbors(var6, var7, var8, Block.MovingPiston.id, dir | (sticky ? 8 : 0));
                    world.setBlockEntity(var6, var7, var8, BlockPistonMoving.createPistonBlockEntity(Block.PistonHead.id, dir | (sticky ? 8 : 0), dir, true, false));
                }
                else
                {
                    world.setBlockWithoutNotifyingNeighbors(var6, var7, var8, Block.MovingPiston.id, var13);
