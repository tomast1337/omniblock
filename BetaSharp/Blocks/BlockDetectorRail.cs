...
public class BlockDetectorRail : BlockRail
{
    ...
    private void updatePoweredStatus(World world, int x, int y, int z, int meta)
    {
        ...
        var minecartsOnRail = world.CollectEntitiesByType<EntityMinecart>(new Box((double)((float)x + detectionInset), (double)y, (double)((float)z + detectionInset), (double)((float)(x + 1) - detectionInset), (double)y + 0.25D, (double)((float)(z + 1) - detectionInset)));
