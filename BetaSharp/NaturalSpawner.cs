...
public class NaturalSpawner
{
    ...
    protected static readonly Type[] nightSpawnEntities =
    [
        typeof(EntitySpider),
        typeof(EntityZombie),
        typeof(EntitySkeleton),
    ];

    protected static BlockPos GetRandomSpawningPointInChunk(World world, int centerX, int centerZ)
    {
    ...
    public static int PerformSpawning(World world, bool var1, bool var2)
    {
        if (!var1 && !var2)
        {
            return 0;
        ...
        else
        {
            ...
            int var3;
            int var6;
            for (var3 = 0; var3 < world.players.Count; ++var3)
            {
                EntityPlayer var4 = world.players[var3];
            ...
            for (int var37 = 0; var37 < var6; ++var37)
            {
                ...
                if ((!var38.isPeaceful() || var2) && (var38.isPeaceful() || var1) && world.countEntities(var38.getCreatureType()) <= var38.getMaxAllowed() * eligibleChunksForSpawning.Count / 256)
                {
                    foreach (var chunk in eligibleChunksForSpawning)
                    {
                        Biome var11 = world.getBiomeSource().GetBiome(chunk);
                        ...
                        int var40 = world.random.NextInt(var13);
                        ...
                        BlockPos var41 = GetRandomSpawningPointInChunk(world, chunk.x * 16, chunk.z * 16);
                        int var42 = var41.x;
                        int var18 = var41.y;
                        int var19 = var41.z;

                        if (world.shouldSuffocate(var42, var18, var19))
                        {
                            continue;
                        }

                        if (world.getMaterial(var42, var18, var19) != var38.getMaterial())
                        {
                            continue;
                        }
                        ...
                        for (int var21 = 0; var21 < 3 && !breakToNextChunk; ++var21)
                        {
                            ...
                            for (int var26 = 0; var26 < 4 && !breakToNextChunk; ++var26)
                            {
                                ...
                                if (canCreatureTypeSpawnAtLocation(var38, world, var22, var23, var24))
                                {
                                    ...
                                    if (world.getClosestPlayer((double)var27, (double)var28, (double)var29, 24.0D) == null)
                                    {
                                        ...
                                        if (var33 >= 576.0F)
                                        {
                                            ...
                                            try
                                            {
                                                var43 = (EntityLiving)Activator.CreateInstance(e!.Type, world)!;
                                            }
                                            ...
                                            var43.setPositionAndAnglesKeepPrevAngles((double)var27, (double)var28, (double)var29, world.random.NextFloat() * 360.0F, 0.0F);
                                            if (var43.canSpawn())
                                            {
                                                ++var20;
                                                world.SpawnEntity(var43);
        ...
        while (true)
        {
            ...
            for (int var8 = 0; var8 < 20 && !var7; ++var8)
            {
                ...
                if (var13 < var11 + 16 && var13 < 128)
                {
                    ...
                    try
                    {
                        entity = (EntityLiving)Activator.CreateInstance(var6[var12], world)!;
                    }
                    catch (java.lang.Exception ex)
                    {
                        ex.printStackTrace();
                    ...
                    if (entity.canSpawn())
                    {
                        PathEntity var18 = pathfinder.createEntityPathTo(entity, var5, 32.0F);
                        if (var18 != null && var18.pathLength > 1)
                        {
                            ...
                            {
                                Vec3i? var20 = BlockBed.findWakeUpPosition(world, MathHelper.Floor(var5.x), MathHelper.Floor(var5.y), MathHelper.Floor(var5.z), 1);
                                if (var20 is (int x, int y, int z))
                                {
	                                entity.setPositionAndAnglesKeepPrevAngles(x + 0.5F, y, z + 0.5F, 0.0F, 0.0F);
                                    world.SpawnEntity(entity);
                                    creatureSpecificInit(entity, world, x + 0.5F, y, z + 0.5F);
