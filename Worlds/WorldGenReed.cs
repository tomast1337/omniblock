    ...
    public class WorldGenReed : WorldGenerator
    {
        ...
        public override bool generate(World var1, java.util.Random var2, int var3, int var4, int var5)
        {
            for (int var6 = 0; var6 < 20; ++var6)
            {
                ...
                if (var1.isAirBlock(var7, var4, var9) && (var1.getMaterial(var7 - 1, var4 - 1, var9) == Material.WATER || var1.getMaterial(var7 + 1, var4 - 1, var9) == Material.WATER || var1.getMaterial(var7, var4 - 1, var9 - 1) == Material.WATER || var1.getMaterial(var7, var4 - 1, var9 + 1) == Material.WATER))
                {
