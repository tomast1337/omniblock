...
{
    public bool IsSideVisible(Block block, IBlockReader reader, int x, int y, int z, Side side, bool defaultVisibility) => (hideAdjacentFaces || reader.GetBlockId(x, y, z) != block.Id) && defaultVisibility;
}
