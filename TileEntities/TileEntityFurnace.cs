    ...
    public class TileEntityFurnace : TileEntity, IInventory
    {
        ...
        private int getFuelTime(ItemStack itemStack)
        {
            ...
            else
            {
                ...
                return var2 < 256 && Block.blocksList[var2].blockMaterial == Material.WOOD ? 300 : (var2 == Item.stick.id ? 100 : (var2 == Item.coal.id ? 1600 : (var2 == Item.bucketLava.id ? 20000 : (var2 == Block.sapling.id ? 100 : 0))));
            }
        }
