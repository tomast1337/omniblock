...
internal class NetherPortalSprite(IBlockRuntimeView blocks) : Rendering.Core.Textures.DynamicTexture(blocks.Get(ResourceLocation.Parse("omniblock:nether_portal")).TextureId)
{
