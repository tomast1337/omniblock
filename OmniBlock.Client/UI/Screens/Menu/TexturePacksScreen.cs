    ...
    TexturePacks texturePackList) : UIScreen(context)
{
    ...
    {
        _texturePackFolder = Path.GetFullPath(Path.Combine(OmniBlock.OmniBlockDir, "texturepacks"));
        ...
        Label title = new()
        {
            Text = Translations.Get("texturePack.title"),
        ...
        Label info = new()
        {
            Text = Translations.Get("texturePack.folderInfo"),
