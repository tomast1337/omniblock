...
internal sealed partial class LuauCompletion
{
    ...
    private static readonly string[] s_clientStateMembers =
        ["backgroundPending", "debugOpen", "foregroundPending", "frameTimeMs", "lightRefreshCompletedCount", "lightRefreshPending", "meshAwaitingDraw", "meshAwaitingUpload", "meshBuildFailureCount", "meshCancelledCount", "meshCooperativeCancellationCount", "meshCriticalCompletedCount", "meshCriticalDeadlineMissCount", "meshCriticalOverdueCount", "meshEvictionGraceCount", "meshLeadingEdgePending", "meshLeadingEdgeQueued", "meshPending", "meshReadyRadius", "meshRequestToGpuMs", "meshSafetyExpectedSections", "meshSafetyHoles", "meshSafetyLoadedColumns", "meshSupersededCount", "oldestForegroundAge", "playerReady", "playerX", "playerY", "playerZ", "presentationRegressionCount", "presentedMeshCount", "residentMeshCount", "worldId", "worldLoaded"];

    private static readonly string[] s_testMembers = ["breakBlock", "creative", "dumpTerrain", "fail", "flyPath", "isMeshCurrent", "meshDeadlineMissCount", "pass", "screenshot", "setFlying", "setLook", "setMovement", "teleport"];
