...
internal sealed partial class LuauCompletion
{
    ...
    private static readonly string[] s_testMembers = ["breakBlock", "creative", "dumpTerrain", "entityBaselineEnvironment", "fail", "flyPath", "isMeshCurrent", "meshDeadlineMissCount", "pass", "screenshot", "setBlock", "setFlying", "setLook", "setMovement", "teleport"];
