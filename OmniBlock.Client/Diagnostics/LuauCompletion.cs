...
internal sealed partial class LuauCompletion
{
    ...
    private static readonly string[] s_clientStateMembers =
        ["backgroundPending", "debugOpen", "emptyLayersSubmitted", "findVisibleMs", "foregroundPending", "frameTimeMs", "frustumTests", "geometryUploadsLastFrame", "lightRefreshCompletedCount", "lightRefreshPending", "lightUploadsLastFrame", "meshAwaitingDraw", "meshAwaitingUpload", "meshBuildFailureCount", "meshCancelledCount", "meshCooperativeCancellationCount", "meshCriticalCompletedCount", "meshCriticalDeadlineMissCount", "meshCriticalOverdueCount", "meshEvictionGraceCount", "meshLeadingEdgePending", "meshLeadingEdgeQueued", "meshPending", "meshReadyRadius", "meshRequestToGpuMs", "meshSafetyExpectedSections", "meshSafetyHoles", "meshSafetyLoadedColumns", "meshSupersededCount", "oldestForegroundAge", "playerReady", "playerX", "playerY", "playerZ", "portalVisited", "presentationRegressionCount", "presentedMeshCount", "presentedSolidLayerCount", "presentedTranslucentLayerCount", "renderDistance", "residentMeshCount", "residentSolidLayerCount", "residentTranslucentLayerCount", "safetyRescued", "simulationDistance", "solidDrawsLastFrame", "terrainDrawCalls", "terrainLodBoundaryBytes", "terrainLodBoundaryLinked", "terrainLodBoundaryPending", "terrainLodBoundaryRefreshes", "terrainLodCacheHits", "terrainLodCacheMisses", "terrainLodConverting", "terrainLodEvictions", "terrainLodGpuBytes", "terrainLodHandoffOverlap", "terrainLodHandoffPreparing", "terrainLodHandoffReversals", "terrainLodHandoffsStarted", "terrainLodLevel0Resident", "terrainLodLevel1Resident", "terrainLodLevelTransitionReversals", "terrainLodLevelTransitions", "terrainLodLevelTransitionsStarted", "terrainLodPending", "terrainLodPresented", "terrainLodRejected", "terrainLodResident", "terrainLodResourceGeneration", "terrainLodResourceReloads", "terrainLodResourceReusedColumns", "terrainLodResourceReusedGpuBytes", "terrainLodStaleResults", "terrainLodTranslucentPresented", "terrainLodUploads", "terrainPipelineBinds", "terrainSubmissionBatches", "terrainSubmitCpuMs", "terrainTextureBinds", "terrainUniformArenaCapacity", "terrainUniformArenaGrowths", "terrainUniformEntries", "translucentDrawsLastFrame", "visibilityCandidates", "worldId", "worldLoaded"];

    private static readonly string[] s_testMembers = ["breakBlock", "countEntities", "creative", "dumpTerrain", "entityBaselineEnvironment", "fail", "flyPath", "isMeshCurrent", "meshDeadlineMissCount", "pass", "screenshot", "setBlock", "setFlying", "setLook", "setMovement", "summon", "teleport"];
