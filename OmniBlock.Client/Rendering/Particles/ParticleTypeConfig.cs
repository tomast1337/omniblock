    ...
    bool animatesTexture)
{
    ...
    static ParticleTypeConfig()
    {
        ...
        Configs[(int)ParticleType.Smoke] = new ParticleTypeConfig(
        ...
        Configs[(int)ParticleType.Rain] = new ParticleTypeConfig(
            PhysicsModel.RainFall, ScaleModel.Constant, BrightnessModel.WorldBased, UVModel.Standard16x16,
            0.98f, 0.7f, -0.06f, false, false);

        Configs[(int)ParticleType.Splash] = new ParticleTypeConfig(
            PhysicsModel.RainFall, ScaleModel.Constant, BrightnessModel.WorldBased, UVModel.Standard16x16,
            0.98f, 0.7f, -0.04f, false, false);

        Configs[(int)ParticleType.Bubble] = new ParticleTypeConfig(
        ...
        for (var i = 0; i < (int)ParticleType.Count; i++)
        {
