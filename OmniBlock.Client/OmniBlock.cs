...

        {
            ...
            LuauClientStateHost.TerrainLodMetric = key =>
            {
                ...
                return key switch
                {
                    ...
                    "terrainCoverageMissingChunkData" => coverage.MissingChunkDataColumns,
                    "terrainCoverageMissingExactMeshes" => coverage.MissingExactMeshColumns,
                    "terrainCoverageMissingPresentation" => coverage.MissingPresentationColumns,
            ...
            if (_e2eTestController != null)
            {
                ...
                LuauTestHost.TerrainLodPresentedMaterial = (x, y, z) =>
                    WorldRenderer?.TerrainLod?.PresentedSpatialMaterialAt(x, y, z) ?? (null, -1, null);
