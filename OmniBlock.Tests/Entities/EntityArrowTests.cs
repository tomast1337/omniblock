...
public sealed class EntityArrowTests
{
    ...
    private static Entity ArrowInGround(FakeWorldContext world)
    {
        ...
        for (var tick = 0; tick < 40 && Flight.Shake(arrow) == 0; tick++) arrow.Tick();
    ...
    public void A_shot_starts_at_the_archers_eyes_and_is_credited_to_them()
    {
        ...
        var arrow = ArrowBehavior.Shoot(world, player);
    ...
    public void A_mobs_arrow_cannot_be_picked_up()
    {
        ...
        var arrow = ArrowBehavior.Shoot(world, skeleton);
    ...
    public void An_arrow_arcs_under_gravity_in_flight()
    {
        ...
        var velocityBefore = arrow.VelocityY;
        arrow.Tick();
    ...
    public void An_arrow_hitting_a_mob_damages_it_and_is_spent()
    {
        ...
        for (var tick = 0; tick < 20 && !arrow.Dead; tick++) arrow.Tick();
    ...
    public void Flight_state_survives_an_nbt_round_trip()
    {
        ...
        var restored = TestEntityCatalog.ByName("arrow").Create(world);
        restored.Read(nbt);
    ...
    {
        var arrow = TestEntityCatalog.ByName("arrow").RequireDefinition();
