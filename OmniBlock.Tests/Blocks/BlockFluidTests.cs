...
public sealed class BlockFluidTests
{
    ...
    public void LavaNeighborUpdate_WithMetaZeroAndAdjacentWater_HardensToObsidian()
    {
        ...
        Assert.Equal(TestBlocks.Get("obsidian").Id, world.Reader.GetBlockId(0, 64, 0));
    }
    ...
    public void FlowingLavaNeighborUpdate_WithMetaBetweenOneAndFourAndAdjacentWater_HardensToCobblestone()
    {
        ...
        Assert.Equal(TestBlocks.Get("cobblestone").Id, world.Reader.GetBlockId(0, 64, 0));
    }
    ...
    public void FlowingLavaNeighborUpdate_WithMetaAboveFourAndAdjacentWater_DoesNotHarden()
    {
        ...
        Assert.Equal(TestBlocks.Get("flowing_lava").Id, world.Reader.GetBlockId(0, 64, 0));
    ...
    public void LavaNeighborUpdate_WithOnlyWaterBelow_DoesNotHarden()
    {
        ...
        Assert.NotEqual(TestBlocks.Get("obsidian").Id, world.Reader.GetBlockId(0, 64, 0));
        Assert.NotEqual(TestBlocks.Get("cobblestone").Id, world.Reader.GetBlockId(0, 64, 0));
