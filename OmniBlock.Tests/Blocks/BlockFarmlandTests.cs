...
public sealed class BlockFarmlandTests
{
    ...
    {
        Block customRevertTarget = TestBlocks.Get("sand");
        FarmlandBehavior behavior = new(customRevertTarget, TestBlocks.Get("wheat"), 4, 5, 4, wet: 0, dry: 0, side: 0);
    ...
    public void NeighborUpdate_SolidBlockAbove_RevertsToConfiguredBlockNotVanillaDirt()
    {
        ...
        Block farmlandBlock = TestBlocks.Get("farmland");
        Block customRevertTarget = TestBlocks.Get("sand");
