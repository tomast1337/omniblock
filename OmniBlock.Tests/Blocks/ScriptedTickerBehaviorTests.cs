...
public sealed class ScriptedTickerBehaviorTests
{
    ...
    public void OnTick_WithRegisteredHook_InvokesHookWithPrimitiveArgs()
    {
        ...
        world.ReaderWriter.SetInitial(1, 64, 2, TestBlocks.Get("stone").Id, meta: 3);
        ...
        behavior.OnTick(TestBlocks.Get("stone"),
            Tick(world, 1, 64, 2, meta: 3, blockId: TestBlocks.Get("stone").Id));
    ...
    {
        FakeWorldContext world = new();
        world.ReaderWriter.SetInitial(5, 64, 5, TestBlocks.Get("stone").Id, meta: 0);
        ...
        behavior.OnTick(TestBlocks.Get("stone"),
            Tick(world, 5, 64, 5, meta: 0, blockId: TestBlocks.Get("stone").Id));
    ...
    public void OnTick_WithUnregisteredHookKey_DoesNothing()
    {
        ...
        behavior.OnTick(TestBlocks.Get("stone"),
            Tick(world, 0, 64, 0, meta: 0, blockId: TestBlocks.Get("stone").Id));
