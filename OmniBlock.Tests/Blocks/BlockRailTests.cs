...
public sealed class BlockRailTests
{
    ...
    public void NeighborUpdate_RailWithoutBlockBelow_BreaksIntoAir()
    {
        ...
        world.ReaderWriter.SetInitial(0, 64, 0, TestBlocks.Get("rail").Id);

        TestBlocks.Get("rail").NeighborUpdate(Tick(world));
    ...
    public void NeighborUpdate_PoweredRailAscendingEastWithoutSupport_BreaksIntoAir()
    {
        ...
        world.ReaderWriter.SetInitial(0, 64, 0, TestBlocks.Get("powered_rail").Id, 2); // ascending east needs support at +X

        TestBlocks.Get("powered_rail").NeighborUpdate(Tick(world));
