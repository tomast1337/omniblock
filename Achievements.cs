...
namespace betareborn
{
    public class Achievements
    {
        ...
        public static Achievement MINE_WOOD = (new Achievement(1, "mineWood", 2, 1, Block.wood, OPEN_INVENTORY)).registerAchievement();
        ...
        public static Achievement BUILD_FURNACE = (new Achievement(4, "buildFurnace", 3, 4, Block.stoneOvenActive, BUILD_PICKAXE)).registerAchievement();
