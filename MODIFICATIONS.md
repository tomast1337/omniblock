...
- 2026-08-10 — Refactor network message classes for improved readability and consistency (Nicolas Vyčas Nery; `45230e7c366c2fcb7689ed7ec75580085f6fa86a`)
...
- 2026-08-30 — feat: implement Luau scheduler with task management and coroutine support (Nicolas Vyčas Nery; `449e66e41f37fe1b69ffe41f0f0fb54aa231701a`)
- 2026-08-30 — feat: add ClientLaunchOptions and ClientReadySignal for command-line configuration and lifecycle management feat: implement UI automation support with AutomationId properties and corresponding tests feat: enhance LuauDomHost with click functionality and integrate it with UI elements test: add unit tests for ClientLaunchOptions and ClientReadySignal, and integration tests for UI automation (Nicolas Vyčas Nery; `b4bc350aad611095d662e13ee50acee2abbe2367`)
...
- 2026-09-03 — Refactor crafting and smelting processes to utilize runtime process registry; add tests for crafting screen and static recipe consumer access (Nicolas Vyčas Nery; `9c16dd9f01f075f9cb292ff210a1f9ef4dd5c005`)
...
- 2026-09-03 — Completed the entity publication and runtime-isolation requirement (Nicolas Vyčas Nery; `f37110538bf14c4d33763ec2f343e6122a35a70a`)
- 2026-09-03 — Enhance entity reference validation and constructor provider registration (Nicolas Vyčas Nery; `e0f45263db76ffa1a2b82ce2cbf99c5dd58087b5`)
...
- 2026-09-09 — refactor: enhance world generation system with dynamic block references and compiled generators (Nicolas Vyčas Nery; `8d7f2aa47b83c4caa6fadbd57807903c14ec8063`)
