    ...
    public class RegionChunkStorage : ChunkStorage
    {
        ...
        public Chunk loadChunk(World world, int chunkX, int chunkZ)
        {
            ...
            if (var4 != null)
            {
                ...
                {
                    Chunk var6 = AlphaChunkStorage.loadChunkFromNbt(world, var4.getCompoundTag("Level"));
                    if (!var6.chunkPosEquals(chunkX, chunkZ))
                    {
                        ...
                        var6 = AlphaChunkStorage.loadChunkFromNbt(world, var4.getCompoundTag("Level"));
                    }
        ...
        public void saveChunk(World world, Chunk chunk, Action onSave, long _)
        {
            ...
            AlphaChunkStorage.storeChunkInCompound(chunk, world, var5);
