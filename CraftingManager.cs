...
namespace betareborn
{
    public class CraftingManager
    {
        ...
        private CraftingManager()
        {
            ...
            addRecipe(new ItemStack(Block.DETECTOR_RAIL, 6), ["X X", "X#X", "XRX", java.lang.Character.valueOf('X'), Item.ingotIron, java.lang.Character.valueOf('R'), Item.redstone, java.lang.Character.valueOf('#'), Block.pressurePlateStone]);
